...
<html lang="fr">
  <head>
    ...
    <title>Fournisseur de services</title>
    <!-- fonts -->
  ...
  <body>
    ...
    <security:authorize access="isFullyAuthenticated()">
      Vous vous êtes précédemment <b>correctement authentifié</b> auprès du fournisseur de services via Azure.<br/>
      <p/>
    ...
    <security:authorize access="!isFullyAuthenticated()">
      ...
      <p/>
      Pour vous authentifier sur ce service via Azure et accéder à la page de fourniture du service, veuillez cliquer sur le lien suivant :<br/> 
      <a href="user"><img alt="Azure" src="static/FCboutons-10.png" /></a>
<p/>
